...
use ExamParser\Dumper\DocxDumper;

class DocxDumperTest extends BaseTestCase
{
    public function testWrite()
    {
        $timestamp = time();
        $filePath = "/tmp/{$timestamp}.docx";
        $dumper = new DocxDumper($filePath);
        $dumper->dump($this->getExampleQuestions());
